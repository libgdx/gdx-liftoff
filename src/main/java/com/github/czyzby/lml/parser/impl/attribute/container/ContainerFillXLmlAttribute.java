 ...
 * {@link Cell#fill(boolean, boolean)}. Mapped to "fillX".
 *
 * @author MJ */
public class ContainerFillXLmlAttribute extends AbstractSharedContainerAndCellLmlAttribute {
    @Override
    protected void applyToContainer(final LmlParser parser, final LmlTag tag, final Container<?> actor,
            final String rawAttributeData) {
        actor.fill(parser.parseBoolean(rawAttributeData, actor), actor.getFillY() > 0f);
    }
