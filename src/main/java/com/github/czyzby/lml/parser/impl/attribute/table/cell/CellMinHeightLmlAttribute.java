...
/** See {@link Cell#minHeight(Value)}. See {@link LmlUtilities#parseHorizontalValue(LmlParser, LmlTag, Actor, String)}
 * and {@link LmlUtilities#parseVerticalValue(LmlParser, LmlTag, Actor, String)} for more info on value parsing. Mapped
 * to "minHeight".
 *
 * @author MJ */
public class CellMinHeightLmlAttribute extends AbstractCellLmlAttribute {
    @Override
