...
/** See {@link Cell#maxHeight(Value)}. See {@link LmlUtilities#parseHorizontalValue(LmlParser, LmlTag, Actor, String)}
 * and {@link LmlUtilities#parseVerticalValue(LmlParser, LmlTag, Actor, String)} for more info on value parsing. Mapped
 * to "maxHeight".
 *
 * @author MJ */
public class CellMaxHeightLmlAttribute extends AbstractCellLmlAttribute {
    @Override
