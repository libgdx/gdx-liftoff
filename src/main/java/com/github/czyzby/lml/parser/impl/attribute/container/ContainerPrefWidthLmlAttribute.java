...
/** See {@link Container#prefWidth(com.badlogic.gdx.scenes.scene2d.ui.Value)}. If container is in a table cell, it also
 * calls {@link Cell#prefWidth(com.badlogic.gdx.scenes.scene2d.ui.Value)}. See
 ...
 * info on value parsing. Mapped to "prefWidth".
 *
 * @author MJ */
public class ContainerPrefWidthLmlAttribute extends AbstractSharedContainerAndCellLmlAttribute {
    @Override
