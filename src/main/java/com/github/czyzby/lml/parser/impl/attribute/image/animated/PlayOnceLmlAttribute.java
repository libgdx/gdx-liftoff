...
/** See {@link AnimatedImage#setPlayOnce(boolean)}. Mapped to "playOnce".
 *
 * @author MJ */
public class PlayOnceLmlAttribute implements LmlAttribute<AnimatedImage> {
    @Override
    ...
    public void process(final LmlParser parser, final LmlTag tag, final AnimatedImage actor,
        ...
        actor.setPlayOnce(parser.parseBoolean(rawAttributeData, actor));
    }
}
