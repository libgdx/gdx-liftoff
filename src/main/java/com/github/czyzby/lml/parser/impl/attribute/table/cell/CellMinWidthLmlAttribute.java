...
/** See {@link Cell#minWidth(Value)}. See {@link LmlUtilities#parseHorizontalValue(LmlParser, LmlTag, Actor, String)}
 * and {@link LmlUtilities#parseVerticalValue(LmlParser, LmlTag, Actor, String)} for more info on value parsing. Mapped
 * to "minWidth".
 *
 * @author MJ */
public class CellMinWidthLmlAttribute extends AbstractCellLmlAttribute {
    @Override
