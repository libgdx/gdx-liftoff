...
/** See {@link ScrollPane#setVelocityY(float)}. Mapped to "velocityY".
 *
 * @author MJ */
public class ScrollVelocityYLmlAttribute implements LmlAttribute<ScrollPane> {
    @Override
    ...
    public void process(final LmlParser parser, final LmlTag tag, final ScrollPane actor,
        ...
        actor.setVelocityY(parser.parseFloat(rawAttributeData, actor));
    }
}
