...
/** See {@link Container#maxSize(com.badlogic.gdx.scenes.scene2d.ui.Value)}. If container is in a table cell, it also
 * calls {@link Cell#maxSize(com.badlogic.gdx.scenes.scene2d.ui.Value)}. See
 ...
 * info on value parsing. Mapped to "maxSize".
 *
 * @author MJ */
public class ContainerMaxSizeLmlAttribute extends AbstractSharedContainerAndCellLmlAttribute {
    @Override
    protected void applyToContainer(final LmlParser parser, final LmlTag tag, final Container<?> actor,
        ...
        actor.maxHeight(LmlUtilities.parseVerticalValue(parser, tag.getParent(), actor, rawAttributeData));
    }
