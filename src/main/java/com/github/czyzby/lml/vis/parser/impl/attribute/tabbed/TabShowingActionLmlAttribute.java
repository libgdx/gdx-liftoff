...
/** See {@link TabbedPaneLmlTag#setShowActionProvider(ActorConsumer)}. Expects an action ID that references a method
 * consuming {@link Tab} (or nothing) and returning an {@link Action}. Invoked each time a tab is shown. Mapped to
 * "tabShowAction".
 *
 * @author MJ */
public class TabShowingActionLmlAttribute extends AbstractTabbedPaneLmlAttribute {
    @Override
