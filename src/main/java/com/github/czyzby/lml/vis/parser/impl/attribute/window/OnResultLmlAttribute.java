 ...
 * hiding will be cancelled. Will look for an action that consumes the {@link Dialog} or {@link VisDialog} rather than
 * the widget that contains the attribute: keep that in mind when attaching methods. Mapped to "result", "onResult",
 * "onDialogResult".
 *
 * @author MJ
 ...
 * @see com.github.czyzby.lml.vis.ui.reflected.ReflectedVisDialog#CANCEL_HIDING */
