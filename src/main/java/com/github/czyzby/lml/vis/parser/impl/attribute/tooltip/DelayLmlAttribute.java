...
/** See {@link Tooltip#setAppearDelayTime(float)}. Mapped to "delay", "appearDelay".
 *
 * @author MJ */
public class DelayLmlAttribute implements LmlAttribute<Tooltip> {
    @Override
    ...
    public void process(final LmlParser parser, final LmlTag tag, final Tooltip actor, final String rawAttributeData) {
        actor.setAppearDelayTime(parser.parseFloat(rawAttributeData, actor));
    }
}
