...
/** See {@link Draggable#setMovingInterpolation(Interpolation)}. Expects an action ID of a method that consumes
 * {@link Draggable} and returns an {@link Interpolation}. Mapped to "movingInterpolation".
 *
 * @author MJ */
