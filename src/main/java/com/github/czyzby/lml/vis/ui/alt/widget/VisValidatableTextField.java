...
package com.github.czyzby.lml.vis.ui.alt.widget;
 ...
 * @see Validators
 */
public class VisValidatableTextField extends TextField {
	...
	public VisValidatableTextField (String text, TextFieldStyle style) {
		super(text, style);
		init();
	}
