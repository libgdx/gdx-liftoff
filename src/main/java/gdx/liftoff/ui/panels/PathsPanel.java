...
public class PathsPanel extends Table implements Panel {
    ...
    public void updateError() {
        ...
        if (UserData.platforms.contains("html") && Configuration.parseJavaVersion(UserData.javaVersion) > 11) {
        ...
        if (UserData.platforms.contains("teavm") && Configuration.parseJavaVersion(UserData.javaVersion) < 11.0) {
