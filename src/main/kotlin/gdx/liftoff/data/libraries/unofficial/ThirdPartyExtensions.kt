...
class TextraTypist : ThirdPartyExtension() {
  ...
  override val defaultVersion = "2.4.4"
...
class FreeTypist : ThirdPartyExtension() {
  ...
  override val defaultVersion = "2.4.4.0"
...
class SpineRuntime : ThirdPartyExtension() {
  ...
  override val defaultVersion = "4.3.5"
  override val url = "https://github.com/EsotericSoftware/spine-runtimes/tree/4.3/spine-libgdx"
...
class RegExodus : ThirdPartyExtension() {
  ...
  override val defaultVersion = "0.1.21"
...
class VisUI : ThirdPartyExtension() {
  ...
  override fun initiateDependencies(project: Project) {
    ...
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/widget/color/internal\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/ButtonBar.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/ColorPicker.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/Common.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/Dialogs.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/FileChooser.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    addTeaConfig(project, ".addAssets(new AssetFileHandle(\"com/kotcrab/vis/ui/i18n/TabbedPane.properties\", com.badlogic.gdx.Files.FileType.Classpath))")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget.spinner")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget.dialog")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget.color")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget.tabbedpane")
    project.reflectedPackages.add("com.kotcrab.vis.ui.widget.toast")
    project.reflectedPackages.add("com.kotcrab.vis.ui.util.form")
    project.reflectedClasses.add("com.kotcrab.vis.ui.Sizes")
    project.reflectedClasses.add("com.kotcrab.vis.ui.util.adapter.SimpleListAdapter")
...
class Fory : ThirdPartyExtension() {
  ...
  override val defaultVersion = "1.7.1"
...
/**
 * Very fast JSON serialization. GWT-incompatible.
 * @author Apache Software Foundation
 */
@Extension
class ForyJson : ThirdPartyExtension() {
  override val id = "foryJson"
  override val defaultVersion = "1.7.1"
  override val url = "https://fory.apache.org/"
  override val group = "org.apache.fory"
  override val name = "fory-json"

  override fun initiateDependencies(project: Project) {
    addDependency(project, Core.ID, "org.apache.fory:fory-json")
  }
}
...
class TinyVG : ThirdPartyExtension() {
  ...
  override val defaultVersion = "83004a633e"
  ...
  override fun initiateDependencies(project: Project) {
    addDependency(project, Core.ID, "com.github.tommyettinger:gdx-TinyVG")
    addDependency(project, GWT.ID, "com.github.tommyettinger:gdx-TinyVG:sources")
...
class Jdkgdxds : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "2.1.9"
...
class KryoRegExodus : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "0.1.21.2"
  override val url = "https://github.com/tommyettinger/kryo-regexodus"
  override val group = "com.github.tommyettinger"
...
class KryoDigital : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "0.10.3.2"
  override val url = "https://github.com/tommyettinger/kryo-digital"
  override val group = "com.github.tommyettinger"
...
class KryoJdkgdxds : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "2.1.9.2"
  override val url = "https://github.com/tommyettinger/kryo-jdkgdxds"
  override val group = "com.github.tommyettinger"
...
class KryoCringe : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "0.3.1.2"
  override val url = "https://github.com/tommyettinger/kryo-cringe"
  override val group = "com.github.tommyettinger"
 ...
 */
@Extension
class KryoGdcrux : ThirdPartyExtension() {
  override val id = "kryoGdcrux"
  override val repository = Repository.JitPack
  override val defaultVersion = "0.1.2.2"
  override val url = "https://github.com/tommyettinger/kryo-gdcrux"
  override val group = "com.github.tommyettinger"
  override val name = "kryo-gdcrux"

  override fun initiateDependencies(project: Project) {
    addDependency(project, Core.ID, "com.github.tommyettinger:kryo-gdcrux")
...
class KryoGand : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "0.3.7.2"
  override val url = "https://github.com/tommyettinger/kryo-gand"
  override val group = "com.github.tommyettinger"
...
class KryoLibgdx : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "1.14.2.2"
  override val url = "https://github.com/tommyettinger/kryo-libgdx"
  override val group = "com.github.tommyettinger"
...
class TantrumLibgdx : ThirdPartyExtension() {
  ...
  override val repository = Repository.JitPack
  override val defaultVersion = "1.7.1.0"
...
class TexturePackerOnly : ThirdPartyExtension() {
  ...
  override val defaultVersion = "1.14.2.0"
