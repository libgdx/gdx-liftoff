...
data class AdvancedProjectData(
   ...
   */
  val gdxTeaVMVersion: String = when (gdxVersion) { // 1.2.1 depends on libGDX 1.13.5, 1.2.0 keeps dep at 1.13.1, and 1.5.4 should be compatible with newer.
    "1.13.5" -> "1.2.1"
    "1.13.1" -> "1.2.0"
    else -> "-SNAPSHOT" // TODO: Change this to 1.5.5 or newer when a new release comes out.
  }
}
