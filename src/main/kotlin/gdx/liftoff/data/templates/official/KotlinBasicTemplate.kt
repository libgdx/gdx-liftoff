...
class KotlinBasicTemplate : KotlinTemplate {
  ...
  override val description = "This project was generated with a template that includes Kotlin application launchers and an empty `ApplicationAdapter` implemented in Kotlin."
