...
installed JDK to be version 17 or higher. Regardless of what platforms you target, Gradle 8.10.1 needs 
a JDK with a version at least 17! You can still target other releases, as low as 8 typically, while building with any of
the JDK versions 17 and up. All stable target releases of Java from 8 to 23 work here now. We use Gradle 8.10.1 because it
